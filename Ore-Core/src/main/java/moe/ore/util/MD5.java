...
public class MD5 {
    ...
    private void md5Memcpy(byte[] bArr, byte[] bArr2, int i, int i2, int i3) {
        if (i3 >= 0) System.arraycopy(bArr2, i2 + 0, bArr, i + 0, i3);
    }
