...
package moe.ore.highway.protobuf.oidb
...
class Cmd0x388 {
    ...
    data class TryUpImgRsp(
        ...
        @ProtoNumber(10) @JvmField var uint64_up_offset: ULong = 0u,
        @ProtoNumber(11) @JvmField var uint64_block_size: ULong = 0u,
    ...
    internal data class ReqBody(
        ...
        @ProtoNumber(7) @JvmField var uint32_command_id: UInt = 0u,
    ...
    internal data class TryUpImgReq(
        ...
        @ProtoNumber(2) @JvmField var srcUin: ULong = 0u,
        @ProtoNumber(3) @JvmField var fileId: ULong = 0u,
        @ProtoNumber(4) @JvmField var fileMd5: ByteArray = EMPTY_BYTE_ARRAY,
        @ProtoNumber(5) @JvmField var fileSize: ULong = 0u,
        @ProtoNumber(6) @JvmField var fileName: String = "",
        @ProtoNumber(7) @JvmField var srcTerm: UInt = 0u,
        @ProtoNumber(8) @JvmField var platformType: UInt = 0u,
        @ProtoNumber(9) @JvmField var buType: UInt = 0u,
        @ProtoNumber(10) @JvmField var picWidth: UInt = 0u,
        @ProtoNumber(11) @JvmField var picHeight: UInt = 0u,
        @ProtoNumber(12) @JvmField var picType: UInt = 0u,
        @ProtoNumber(13) @JvmField var buildVer: String = "",
        @ProtoNumber(14) @JvmField var innerIp: UInt = 0u,
        @ProtoNumber(15) @JvmField var appPicType: UInt = 0u,
        @ProtoNumber(16) @JvmField var originalPic: UInt = 0u,
        @ProtoNumber(17) @JvmField var fileIndex: ByteArray = EMPTY_BYTE_ARRAY,
        @ProtoNumber(18) @JvmField var dstUin: ULong = 0u,
        @ProtoNumber(19) @JvmField var srvUpload: UInt = 0u,
